...
!function(e, t) {
    ...
    function arcToSegment(e, t, n, s, i, o, r, a, u) {
        if (e !== a || t !== u) {
            ...
            A %= g,
            R %= g;
            var G, L = Math.ceil(B(R) / (g / 4)), j = [], z = R / L, I = 4 / 3 * Y(z / 2) / (1 + k(z / 2)), W = f * n, H = c * n, Q = c * -s, Z = f * s;
            for (G = 0; G < L; G++)
                m = k(i = A + G * z),
                p = Y(i),
                _ = k(i += z),
    ...
    function stringToRawPath(e) {
        ...
        for (t = 0; t < w; t++)
            ...
            "M" === o)
                ...
                r || (x = y = 0),
                (a = a || [0, 0]).push(s, i, x + 1 * m[t + 3], y + 1 * m[t + 4], x += 1 * m[t + 5], y += 1 * m[t + 6]),
                t += 6;
            else if ("S" === o)
                f = x,
                c = y,
                "C" !== g && "S" !== g || (f += x - a[a.length - 4],
                c += y - a[a.length - 3]),
                r || (x = y = 0),
                ...
                f = x - a[a.length - 4],
                c = y - a[a.length - 3],
                a.push(x + f, y + c, s + 2 / 3 * (x + 1.5 * f - s), i + 2 / 3 * (y + 1.5 * c - i), x = s, y = i),
                t += 2;
            else if ("H" === o)
                ib(x, y, x = s, y),
                t += 1;
                ...
                i = h,
                a.closed = !0),
                ("L" === o || .5 < B(x - s) || .5 < B(y - i)) && (ib(x, y, s, i),
                "L" === o && (t += 2)),
                x = s,
                y = i;
            else if ("A" === o) {
                ...
                d = v.charAt(1),
                v = v.charAt(0)),
                l = arcToSegment(x, y, +m[t + 1], +m[t + 2], +m[t + 3], +v, +d, (r ? x : 0) + 1 * f, (r ? y : 0) + 1 * c),
                t += n,
                l)
    ...
    function C(e, t, n, s, i, o, r, a, u, h, f) {
        var c, l = (e + n) / 2, g = (t + s) / 2, v = (n + i) / 2, d = (s + o) / 2, m = (i + r) / 2, p = (o + a) / 2, x = (l + v) / 2, y = (g + d) / 2, w = (v + m) / 2, M = (d + p) / 2, E = (x + w) / 2, b = (y + M) / 2, P = r - e, S = a - t, N = Math.abs((n - r) * S - (s - a) * P), T = Math.abs((i - r) * S - (o - a) * P);
        return h || (h = [{
            x: e,
            y: t
        }, {
        ...
        u * (P * P + S * S) < (N + T) * (N + T) && (c = h.length,
        C(e, t, l, g, x, y, E, b, u, h, f),
        C(E, b, w, M, m, p, r, a, u, h, f + 1 + (h.length - c))),
        h
    }
    var y, i, t, o = "CustomEase", r = v(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), a = function(e) {
        ...
        if (this.data = e,
        (w.test(e) || ~e.indexOf("M") && e.indexOf("C") < 0) && (c = stringToRawPath(e)[0]),
        4 === (n = c.length))
            c.unshift(0, 0),
            c.push(1, 1),
            n = 8;
        ...
        for (0 == +c[0] && 1 == +c[n - 2] || function _normalize(e, t, n) {
            ...
            var s, i = -1 * e[0], o = -n, r = e.length, a = 1 / (+e[r - 2] + i), u = -t || (Math.abs(e[r - 1] - e[1]) < .01 * (e[r - 2] - e[0]) ? function _findMinimum(e) {
        ...
        o = 2; o < n; o += 6)
            ...
            g.push(s, i),
            C(s.x, s.y, +c[o], +c[o + 1], +c[o + 2], +c[o + 3], i.x, i.y, 1 / (2e5 * d), g, g.length - 1);
        for (n = g.length,
        o = 0; o < n; o++)
            u = g[o],
            h = g[o - 1] || u,
            (u.x > h.x || h.y !== u.y && h.x === u.x || u === h) && u.x <= 1 ? (h.cx = u.x - h.x,
            h.cy = u.y - h.y,
            h.n = u,
            h.nx = u.x,
            m && 1 < o && 2 < Math.abs(h.cy / h.cx - g[o - 2].cy / g[o - 2].cx) && (m = 0),
            h.cx < l && (h.cx ? l = h.cx : (h.cx = .001,
            o === n - 1 && (h.x -= .001,
            l = Math.min(l, .001),
            m = 0)))) : (g.splice(o--, 1),
            n--);
        ...
        ,
        (this.ease.custom = this).id && y && y.registerEase(this.id, this.ease),
        this
    }
    ,
    ...
    CustomEase.getSVGData = function getSVGData(e, t) {
        var n, i, o, r, a, u, h, f, c, l, g = (t = t || {}).width || 100, v = t.height || 100, d = t.x || 0, p = (t.y || 0) + v, x = y.utils.toArray(t.path)[0];
        if (t.invert && (v = -v,
        p = 0),
        ...
        e instanceof CustomEase)
            n = function rawPathToString(e) {
                ...
                var t, n, s, i, o = "", r = e.length;
                for (n = 0; n < r; n++) {
                    for (i = e[n],
                    o += "M" + m(i[0]) + "," + m(i[1]) + " C",
                    t = i.length,
                    s = 2; s < t; s++)
                        o += m(i[s++]) + "," + m(i[s++]) + " " + m(i[s++]) + "," + m(i[s++]) + " " + m(i[s++]) + "," + m(i[s]) + " ";
                    i.closed && (o += "z")
                }
                return o
            ...
            o = 2; o < h; o++)
                a = s(d + o * r * g),
                u = s(p + e(o * r) * -v),
                (Math.abs((u - l) / (a - c) - i) > f || o === h - 1) && (n.push(c, l),
                i = (u - l) / (a - c)),
                c = a,
                l = u;
            n = "M" + n.join(",")
